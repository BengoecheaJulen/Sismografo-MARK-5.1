...
The model is based on a proprietary complex systems quantitative framework that processes independent market factors daily. Its signals are **structurally decorrelated** from all standard financial models
...
El modelo está basado en un framework cuantitativo propietario de sistemas complejos que procesa factores de mercado independientes diariamente. Sus señales están **estructuralmente descorrelacionadas** de todos los modelos financieros estándar.
